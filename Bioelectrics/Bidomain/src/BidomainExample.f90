...
PROGRAM BIDOMAINEXAMPLE
  ...
  CALL CMISSRegion_LabelSet(Region,"BidomainRegion",Err)
  ...
  CALL CMISSField_Initialise(ParabolicEquationsSetField,Err)
  CALL CMISSEquationsSet_CreateStart(ParabolicEquationsSetUserNumber,Region,GeometricField,CMISS_EQUATIONS_SET_BIOELECTRICS_CLASS, &
    & CMISS_EQUATIONS_SET_BIDOMAIN_EQUATION_TYPE,CMISS_EQUATIONS_SET_FIRST_BIDOMAIN_SUBTYPE,ParabolicEquationsSetFieldUserNumber, &
  ...
  CALL CMISSField_Initialise(EllipticEquationsSetField,Err)
  CALL CMISSEquationsSet_CreateStart(EllipticEquationsSetUserNumber,Region,GeometricField,CMISS_EQUATIONS_SET_BIOELECTRICS_CLASS, &
    & CMISS_EQUATIONS_SET_BIDOMAIN_EQUATION_TYPE,CMISS_EQUATIONS_SET_SECOND_BIDOMAIN_SUBTYPE,EllipticEquationsSetFieldUserNumber, &
  ...
  DO node_idx=1,NUMBER_OF_ELEMENTS/2
    ...
    IF(NodeDomain==ComputationalNodeNumber) THEN
      CALL CMISSField_ParameterSetUpdateNode(CellMLParametersField,CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_VALUES_SET_TYPE, &
        & 1,1,node_idx,stimcomponent,STIM_VALUE,Err)
    ENDIF
  ENDDO
  ...
  DO node_idx=1,(NUMBER_OF_ELEMENTS+1)*(NUMBER_OF_ELEMENTS+1)
    ...
    CALL CMISSField_ParameterSetUpdateNode(CellMLParametersField,CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_VALUES_SET_TYPE, &
      & 1,1,node_idx,gNacomponent,gNa_VALUE,Err)
  ENDDO
  ...
  DO node_idx=1,NUMBER_OF_ELEMENTS/2
    ...
    IF(NodeDomain==ComputationalNodeNumber) THEN
      CALL CMISSField_ParameterSetUpdateNode(CellMLParametersField,CMISS_FIELD_U_VARIABLE_TYPE,CMISS_FIELD_VALUES_SET_TYPE, &
        & 1,1,node_idx,stimcomponent,0.0_CMISSDP,Err)
    ENDIF
  ENDDO !node_idx
